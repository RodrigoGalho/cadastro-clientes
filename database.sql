...
--
-- Host: 127.0.0.1
-- Generation Time: 16-Nov-2016 às 21:51
...
CREATE TABLE IF NOT EXISTS `cidade` (
  ...
  `DSNome` varchar(120) DEFAULT NULL,
  `FKEstado` int(5) DEFAULT NULL
...
INSERT INTO `cidade` (`PKCidade`, `DSNome`, `FKEstado`) VALUES
(1, 'Afonso Cláudio', 8),
...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `DSEmail` varchar(150) CHARACTER SET latin1 NOT NULL,
  `DSNome` varchar(250) CHARACTER SET latin1 NOT NULL,
  `DTNascimento` date DEFAULT NULL,
  `DSLogradouro` varchar(250) CHARACTER SET latin1 DEFAULT NULL,
  `NMNumero` int(11) DEFAULT NULL,
  `DSComplemento` varchar(150) CHARACTER SET latin1 DEFAULT NULL,
  `DSCep` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
...
INSERT INTO `cliente` (`PKCliente`, `DSEmail`, `DSNome`, `DTNascimento`, `DSLogradouro`, `NMNumero`, `DSComplemento`, `DSCep`, `DTRegistro`, `DTAtualizacao`, `FKCidade`) VALUES
(7, 'rodrigo.rebirth@gmail.com', 'Rodrigo Galho', '1986-02-05', 'Av. Visconde de mauá', 503, 'A', '96330-000', '2016-05-25', '2016-05-25', 3875),
(8, 'mariaregina@gmail.com', 'Maria Regina Gonçalves', '1988-05-18', 'Voluntarios da pátria', 5556, 'B', '96112-000', '2016-05-25', '2016-05-19', 81),
(10, 'joca@gmail.com', 'Augusto Sérgio', '1986-07-02', 'Rua Gen. Neto', 2356, 'Apto 257', '96050-642', '2016-05-25', '2016-09-06', 204),
(11, 'mauricio@yahoo.com.br', 'Mauricio Rodrigues', '1982-08-25', 'Rua 7 de Abril', 23, 'Fundos', '96020-000', '2016-05-25', '2016-05-25', 221),
(12, 'genivaldo@gmail.com', 'Genivaldo', '1990-03-14', 'Rua General Osório', 253, '', '96020-000', '2016-11-16', '2016-11-16', 3989);
...
CREATE TABLE IF NOT EXISTS `estado` (
  ...
  `DSNome` varchar(75) DEFAULT NULL,
  `DSUf` varchar(5) DEFAULT NULL
...
INSERT INTO `estado` (`PKEstado`, `DSNome`, `DSUf`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
CREATE TABLE IF NOT EXISTS `telefone` (
  `PKTelefone` int(11) NOT NULL,
  `DSTelefone` varchar(14) DEFAULT NULL,
...
INSERT INTO `telefone` (`PKTelefone`, `DSTelefone`, `FKCliente`) VALUES
(13, '(53) 8412-7140', 7),
(14, '(53) 3262-2439', 7),
(16, '(53) 8412-7544', 8),
(17, '(53) 8122-6598', 8),
...
ALTER TABLE `telefone`
  ADD PRIMARY KEY (`PKTelefone`),
  ADD KEY `telefone_ibfk_1` (`FKCliente`);
...
--
ALTER TABLE `cidade`
  MODIFY `PKCidade` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5565;
--
-- AUTO_INCREMENT for table `cliente`
--
ALTER TABLE `cliente`
  MODIFY `PKCliente` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `estado`
--
ALTER TABLE `estado`
  MODIFY `PKEstado` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `telefone`
--
ALTER TABLE `telefone`
  MODIFY `PKTelefone` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `cidade_ibfk_1` FOREIGN KEY (`FKEstado`) REFERENCES `estado` (`PKEstado`);

--
-- Limitadores para a tabela `telefone`
--
ALTER TABLE `telefone`
  ADD CONSTRAINT `telefone_ibfk_1` FOREIGN KEY (`FKCliente`) REFERENCES `cliente` (`PKCliente`) ON DELETE CASCADE;
